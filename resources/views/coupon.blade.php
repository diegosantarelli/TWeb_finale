...
@section('content')
    ...
    <link rel="stylesheet" type="text/css" href="css/PaginaCoupon.css">
    
<!-- <div class="card-container">
  <div class="card">
    <div class="card-image">
      <img src="https://via.placeholder.com/150x150" alt="Offerta">
    </div>
    <div class="card-details">
      <h2>Offerta speciale</h2>
      <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed quis magna vel augue imperdiet fermentum. Vivamus in tortor auctor, iaculis urna eu, fringilla ex. Ut sollicitudin finibus lorem ut tincidunt. Nullam nec arcu quis turpis luctus rutrum vel at arcu.</p>
      <a href="#" class="coupon-button">Applica Coupon</a>
    </div>
  </div>
</div> -->
...
<section class="product">
  ...
  <div class="product-info">
    ...
    <p class="prezzo_originale">Prezzo originale: $40.00</p>
    <p class="prezzo_scontato">Prezzo scontato: $19.99</p>
   <button class=button>Ottieni Coupon</button>
  </div>
</section>
